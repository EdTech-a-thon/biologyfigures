...
<Seo title="About" description="Biology Figures is a free set of generators for printable biology figures, from teacher.dev." path="/about" />

<div class="page">
  <a class="back" href="/">← All figures</a>
  <h1>About</h1>
  <p class="sub">Clean biology figures, made to fit your lesson.</p>
  ...
  <section class="card">
    ...
    <p>
      Biology Figures is a set of generators for the figures teachers put in tests and worksheets.
      It's a project from
  ...
  <section class="card">
    ...
    <a class="btn-dark" href="mailto:directors@teacher.dev?subject=Biology%20Figures%20feedback">Email directors@teacher.dev</a>
  </section>
</div>
