...
<div class="page">
  <header class="hero">
    <h1>Biology figures for your tests and worksheets</h1>
  ...
  <div class="search">
    ...
    <input type="search" bind:value={query} placeholder="Search figures, like “cell diagram”" aria-label="Search figures" autocomplete="off" />
  </div>
